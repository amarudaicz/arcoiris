...
function FeaturedProductGrid(options = {}) {
    ...
    function _createRootElement() {
        const element = document.querySelector('[data-component="FeaturedProductGrid"]');
...
<div data-js="paginator-container">
    ...
    function _setupPaginator() {
        _paginator = new Paginator(_paginatorContainerElement, {entriesPerPage: 6});
    }
    ...
    function _downloadPDF() {
        disableEntryButton(_downloadButtonElements[0]);

        setTimeout(() => {
            window.open('/products/featured/download/pdf', "_blank");
            enableEntryButton(_downloadButtonElements[0]);
        }, 400);
    }
